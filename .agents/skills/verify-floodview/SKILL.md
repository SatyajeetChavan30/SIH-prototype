...
The `/verify-floodview` skill executes the complete testing framework specified in AGENTS.md:
...
**Initialized**: Skill scaffold created and registered in `.Codex/skills/verify-floodview/`
