...
class TestSphBackendSelection:
    ...
    generated by compyle. On Python 3.14 compyle 0.9.1 cannot generate them
    (it uses ast.Str). "auto" must then fall back to the CPU and say why: an
    auto choice that picked the GPU and crashed would lose the whole run.
    """
    ...
    def test_gpu_path_keeps_float64(self, monkeypatch):
        ...
        assert choice["argv"] == ["--opencl", "--use-double"]
