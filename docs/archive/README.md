...
| :--- | :--- | :--- | :--- |
| `ARCHITECTURE_IMPROVEMENTS.md` | The `/improve-architecture` pass that created the `jalraksha/` package and moved presentation tooling to `tools/` | 2026-08-23 | CLAUDE.md "Repository layout" |
...
| `PHASE1_STATUS.md` | Solver scaffolding with the lake-at-rest gate still failing (moved from `jalraksha/solver/`) | 2026-08-24 | `tests/test_solver.py` — the gate passes at machine precision |
...
| `report.md`, `report.html` | A technical reference written while SPH, GEE and the Impact tab were still unwired | 2026-08-30 | `docs/JalRaksha_Technical_Reference_Manual.md`, `docs/dashboard_integration.md` |
