...
The `/build-phase` skill stages the execution of a single phase from the 18-phase build plan specified in CLAUDE.md. It:
...
1. Claude checks pre-flight conditions
...
- **Licensing**: Verify approved vs forbidden sources before adding new data dependencies (see CLAUDE.md)

## Status (Aug 2026)

**Initialized**: Skill scaffold created and registered in `.claude/skills/build-phase/`
