...
- [ ] Unvetted coefficients flagged with `# TODO: UNVETTED` + source requirement (per CLAUDE.md)
...
**Initialized**: Skill scaffold created and registered in `.claude/skills/code-quality-deep-dive/`
