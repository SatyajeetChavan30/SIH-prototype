...
Generates Delft3D FM input files from FloodView dam configuration:
...
# Generated by FloodView for dam-break simulation
...
def setup_delft3d_model(
    ...
    """
    Generate complete Delft3D FM input files from FloodView dam config.
