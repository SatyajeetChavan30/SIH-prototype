...
Produces the complete input set the real `dflowfm-cli` kernel needs:
    ...
    <name>_net.nc      UGRID mesh with bed level on nodes (floodview.delft3d.ugrid)
...
from floodview.delft3d.ugrid import write_ugrid_net
...
def _render_mdu(name: str, net_file: str, obs_file: Optional[str],
    ...
    return f"""# D-Flow FM model generated by FloodView (SIH 2026, PS 26161)
...
<dimrConfig xmlns="http://schemas.deltares.nl/dimr"
  ...
  <documentation>
    ...
    <createdBy>FloodView (SIH 2026, PS 26161)</createdBy>
  </documentation>
  <control>
    <start name="{name}"/>
  </control>
