...
- Hazard-class shapefile export (floodview.export.shapefile)
...
floodview/export/shapefile.py and in the frontend. They disagreed: a cell
...
mapping belongs beside the WorldCover legend in floodview.terrain.roughness
...
#
# Matches Result.wet_mask in floodview.solver.types: deliberately well above
...
class HazardClassifier:
    ...
    def classify_from_speed(
        ...
        (floodview.solver.parallel accumulates np.hypot(u, v)), so callers
...
def compute_fd2320_hazard_rating_from_speed(
    ...
    np.hypot(u, v) — see floodview.solver.parallel.
